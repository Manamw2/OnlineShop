...
namespace Server.Controllers
{
    ...
    public class AccountController:ControllerBase
    {
        ...
        public AccountController(UserManager<AppUser> userManager, ITokenService tokenService, SignInManager<AppUser> signInManager, RoleManager<Role> roleManager, IRolePermissionService rolePermissionService, IMapper mapper1)
        {
